...
<!-- Start: Theme Preview Pane -->
 ...
 <ul class="nav navbar-nav navbar-right">
        ...
        <li class="hidden-xs">
                     <a href="http://localhost:8080/worldcup2018/backend/web/">
          ...
          <div class="sidebar-widget author-widget">
            <div class="media">
              <a class="media-left" href="#">
                 <img src="../web/statics/assets/img/avatars/1.jpg" class="img-responsive">
              </a>
              <div class="media-body">
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle">用户菜单-</a> <a href="http://localhost:8080/worldcup2018/backend/web/" data-method="post">登出 </a>
                </div>
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['department/index']) ?>">
              ...
              <span class="sidebar-title">作业查看</span>
            ...
            <ul class="nav sub-nav">
              <li>
                ...
                <a href="./data/personal/1611525_韩叶.pdf">
                  <span class="glyphicon glyphicon-book"></span> 1611525 韩  叶</a>
              </li>
              <li>
                <a href="./data/personal/1611529_林美含.pdf">
                  <span class="glyphicon glyphicon-book"></span> 1611529 林美含</a>
              </li>
              <li>
                <a href="./data/personal/1611530_刘俐君.pdf">
                  <span class="glyphicon glyphicon-book"></span> 1611530 刘俐君</a>
              </li>
              <li>
                <a href="./data/personal/1611533_王艺茹.pdf">
                  <span class="glyphicon glyphicon-book"></span> 1611533 王艺茹</a>
              <li>
                <a href="./data/personal/1611540_钟捷凌.pdf">
                  <span class="glyphicon glyphicon-book"></span> 1611540 钟捷凌</a>
              </li>
          ...
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['batch/index']) ?>">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">个人信息管理</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
             
              <li>
                <a href="http://localhost:8080/worldcup2018/backend/web/index.php?r=personal-info">
                  <span class="glyphicon glyphicon-book"></span> 查询删除及更新</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['personal-info/create']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 新建成员</a>
              </li>
            </ul>
          </li>
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['level-index/index']) ?>">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">赌球记录管理</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="http://localhost:8080/worldcup2018/backend/web/index.php?r=wc-gamble-record">
                  <span class="glyphicon glyphicon-book"></span> 查询删除及更新</a>
              </li>
              <li>
                <a href="http://localhost:8080/worldcup2018/backend/web/index.php?r=personal-info%2Fcreate">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
                <a href="./data/teamwork/队员介绍.pdf">
                  <span class="glyphicon glyphicon-book"></span> 团队介绍PPT</a>
              </li>
